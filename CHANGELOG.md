...
- **The webview stylesheets are now split by component.** The single
  `media/main.css` file has been divided into eight focused stylesheets —
  tokens, page shell, commit table, commit details, ref labels, toolbar,
