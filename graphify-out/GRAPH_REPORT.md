...
## Corpus Check
- 257 files · ~206,912 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2555 nodes · 5940 edges · 151 communities (137 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 42 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b2593d64`
...
Cohesion: 0.06
Nodes (26): addTag(), AddTagInput, deleteTag(), DeleteTagInput, pushAllTags(), PushAllTagsInput, pushTag(), PushTagInput (+18 more)
...
Cohesion: 0.10
Nodes (17): commitDetailsFileViewModes, customBranchGlobPatterns(), DEFAULT_GRAPH_COLORS, getColorConfig(), getConfig(), getConfigWithLegacy(), getExplicitConfig(), getNumberConfig() (+9 more)

### Community 6 - "messageHandler.ts"
Cohesion: 0.07
Nodes (59): checkoutCommit(), cherrypickCommit(), CommitActionInput, CommitActionPayloads, dropCommit(), dropCommitSelection(), editHeadCommitMessage(), normalizeCommitMessage() (+51 more)

### Community 7 - "types.ts"
Cohesion: 0.05
Nodes (40): GitGraphViewState, JsonPrimitive, RequestCompareFileWithWorkingTree, RequestCopyToClipboard, RequestExportExtensionSettings, RequestFetchAvatar, RequestImportExtensionSettings, RequestImportRepoConfig (+32 more)
...
Cohesion: 0.08
Nodes (50): GitRepoConfig, GitTagDetails, ExtensionSetting, booleanSettingOrder, configValueText(), firstRemoteUrl(), getRepoBasename(), getRepoDisplayName() (+42 more)
...
Cohesion: 0.19
Nodes (12): gitClientFactory(), GitInstance, decodeDiffDocUri(), decodeUriQueryArgs(), DiffDocProvider, activate(), initL10n(), createConsentPrompt() (+4 more)
...
Cohesion: 0.05
Nodes (37): GitCommitDetails, GitRemote, GitStash, COMMIT_ORDERINGS, CommitDetailsResult, LoadBranchesResult, LoadCommitsResult, LoadRepoInfoResult (+29 more)
...
Cohesion: 0.06
Nodes (47): addUnsavedChangesCommit(), buildLogArgs(), buildLogFormat(), buildRefFormat(), createCommitNodes(), getLog(), getRefs(), getUnreachableCommitHashes() (+39 more)

### Community 34 - "webviewL10n.ts"
Cohesion: 0.09
Nodes (23): GitRepoInfo, bootWebview(), commits, defaultViewState, latestRequest(), repoInfo, mount(), viewStateFixture (+15 more)
...
Cohesion: 0.10
Nodes (33): dependencies, simple-git, simple-git, checkoutBranch(), createBranch(), deleteBranch(), DeleteBranchInput, renameBranch() (+25 more)
...
Cohesion: 0.13
Nodes (16): Config, createRepoManager(), createLogger(), Logger, timestamp(), StatusBarItem, TelemetryReporter, TelemetryReporterOptions (+8 more)
...
Cohesion: 0.22
Nodes (5): ContextMenuHeader, ContextMenuItem, getSectionToggleLabel(), isUncommittedSection(), UncommittedSection
...
Cohesion: 0.12
Nodes (23): getNonce(), buildExtensionUri(), buildTelemetryConsentScreen(), escapeHtml(), buildWebviewHtml(), escapeJsonForHtml(), bundlePath(), createBundleTranslator() (+15 more)

### Community 92 - "git-graph-libre.maxDepthOfRepoSearch"
Cohesion: 0.08
Nodes (28): deleteUserDetails(), editUserDetails(), requireScope(), requireValue(), setConfigValue(), unsetConfigValue(), UserConfigActionInput, UserConfigActionPayloads (+20 more)

### Community 93 - "git-graph-libre.revealHighlightColor"
Cohesion: 0.17
Nodes (15): loadBranches(), LoadBranchesInput, isGitRepository(), evalPromises(), toRejectionError(), isHiddenRemoteRef(), normalizeHiddenRemotes(), remoteExcludeArgs() (+7 more)
...
Cohesion: 0.11
Nodes (27): GitUncommittedChanges, getStagingDropAction(), RenderUncommittedDetailsOptions, renderUncommittedDetailsRowHtml(), renderUncommittedFileItem(), renderUncommittedFileList(), renderUncommittedFolder(), renderUncommittedNode() (+19 more)
...
Cohesion: 0.12
Nodes (23): vscode, doesPathExist(), getPathFromUri(), isDirectory(), RepoManager, createRepoSearch(), RepoSearch, ScanLogger (+15 more)
...
Cohesion: 0.15
Nodes (9): CommitLoadFacts, createViewFeatureReporter(), hasNestedRepo(), isNestedRepo(), ViewFeatureReporter, branch, quietLoad, signedTag (+1 more)
...
## Knowledge Gaps
- **809 isolated node(s):** `path`, `esbuild`, `production`, `esbuildProblemMatcherPlugin`, `aliasPlugin` (+804 more)
...
- **Why does `simple-git` connect `queries.types.ts` to `searchCommits.ts`, `git-graph-libre.revealHighlightColor`, `messageHandler.ts`?**
  _High betweenness centrality (0.245) - this node is a cross-community bridge._
- **Why does `dependencies` connect `queries.types.ts` to `package.json`?**
  _High betweenness centrality (0.245) - this node is a cross-community bridge._
